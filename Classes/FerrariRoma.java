...
public class FerrariRoma extends JFrame
{
    ...
    public FerrariRoma(String cNameStore, String cEmailStore, String cAddressStore, String cPhoneNumberStore, String cPassStore)
    {
        ...
        brand = new JLabel("Brand: Ferrari");
        ...
        model = new JLabel("Model: Roma 2022");
