...
{  
    ...
    protected String cNameStore, cEmailStore, cAddressStore, cPhoneNumberStore, cPassStore, price;

    public Payment(String cNameStore, String cEmailStore, String cAddressStore, String cPhoneNumberStore, String cPassStore, String price)
    {
